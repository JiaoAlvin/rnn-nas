...
class ModelFitness(object):
    ...
    def __str__(self):
        return f'[{self.identifier}]: {self.number_of_parameters}, {self.number_of_functions}, {self.number_of_mul},' \
               f'<{self.sine_wave_loss}, {self.sine_wave_ma_error}, {self.lang_loss}, {self.lang_accuracy}>'
